...
class TestPythonWebCrawler(unittest.TestCase):
    ...
    def test_url_normalization(self):
        ...
        # Test invalid URLs
        self.assertIsNone(
            self.crawler._normalize_url("https://example.com", "javascript:void(0)")
        )
        self.assertIsNone(
    ...
    def test_domain_filtering(self):
        ...
        # Same domain
        self.assertTrue(
            self.crawler._is_allowed_domain("https://example.com", "https://example.com/page")
        )

        # Different domain
        self.assertFalse(
            self.crawler._is_allowed_domain("https://example.com", "https://other.com")
        )
    ...
    def test_path_filtering(self):
        ...
        self.assertTrue(
            crawler_no_inside._is_inside_path("https://example.com/path", "https://example.com/other")
        )
